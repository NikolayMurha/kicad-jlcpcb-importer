...
class JLCPCBTools(wx.Dialog):
    ...
    def logbox_append(self, e):
        ...
        # Use AppendText to ensure updates on read-only TextCtrl
        self.logbox.AppendText(e.msg)
...
class LogBoxHandler(logging.StreamHandler):
    ...
    def emit(self, record):
        ...
        # Use PostEvent for thread-safe event delivery (consistent with other updates)
        wx.PostEvent(self.event_destination, LogboxAppendEvent(msg=f"{msg}\n"))
