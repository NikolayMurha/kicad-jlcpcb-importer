...
class Library:
    ...
    def categories(self):
        ...
        # Exclude the empty key used as internal root and prepend "All"
        cats = [k for k in self.category_map.keys() if k and str(k).strip()]
        return ["All"] + cats

    def get_subcategories(self, category):
        """Get the subcategories associated with the given category."""
        # Gracefully handle "All" or unknown categories
